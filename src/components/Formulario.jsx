...
const Formulario = ({cliente, cargando }) => {
    ...
    return (
        cargando ? <Spinner /> : ( 
        <div className='bg-yellow-300 mt-10 px-5 py-10 rounded-md shadow-md md:w-3/4 mx-auto'>
                ...
                >
                    ...
                    <Form className='mt-10'>
                        ...
                        <input type="submit" value={cliente?.nombre ? 'Editar Cliente' : 'Agregar Cliente' } className='mt-5 w-full bg-black text-white p-3 uppercase font-bold text-lg rounded-md' />
                    </Form>
                    )}}
                </Formik>
